...
<html lang="en">
   <head>
      ...
      <link rel="stylesoeet" href="{{ asset('./html/css/owl.theme.default.min.css') }}">
      ...
      <div class="banner_bg_main">
         ...
         <div class="logo_section">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="logo"><a href="index.html"><img src="{{ asset('./html/images/logo.png') }}"></a></div>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="header_section">
            <div class="container">
               <div class="containt_main">
                  ...
                  <span class="toggle_icon" onclick="openNav()"><img src="{{ asset('./html/images/toggle-icon.png') }}"></span>
                  <div class="dropdown">
                  ...
                  <div class="header_box">
                     <div class="lang_box ">
                        ...
                        <img src="{{ asset('./html/images/flag-uk.png') }}" alt="flag" class="mr-2 " title="United Kingdom"> English <i class="fa fa-angle-down ml-2" aria-hidden="true"></i>
                        </a>
                        <div class="dropdown-menu ">
                           <a href="#" class="dropdown-item">
                           <img src="{{ asset('./html/images/flag-france.png') }}" class="mr-2" alt="flag">
                           French
                           </a>
                        </div>
                     </div>
